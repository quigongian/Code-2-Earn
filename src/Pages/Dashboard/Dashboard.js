  ...
  return(
    ...
    <nav class="nav nav-underline" >
        ...
        <a class="nav-link text-black" href="/Preferences"> Wallet</a>
          ...
          <p class="lead text-light">Here you will be able to solve coding questions and earn Coins for each question that is completed successfully. Note that harder questions pay more than easier ones. Happy coding!</p>
          <p>
